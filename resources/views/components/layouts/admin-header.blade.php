<header class="navbar">
    <div class="container navbar-content">
        <a href="/" class="logo-wrapper">
            <img src="/img/lamilam.jpeg" alt="Logo" class="logo" />
        </a>
        ...
        <div class="navbar-auth">
            <a href="#" class="btn btn-add-new-car">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <div class="navbar-menu" tabindex="-1">
                ...
                <ul class="submenu">
                    ...
                    <li>
                        <a href="{{ route('car.search') }}">All Cars</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.viewedCar') }}">Viewed Cars</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.pending.cars') }}">Pending Cars</a>
                    </li>
                    <li>
            ...
            <a href="{{ route('profile') }}" class="header-profile-link">
                <x-user-image :user="auth()->user()" class="my-cars-img-thumbnail" />
                <span class="header-profile-text">Hi, {{ auth()->user()->name }}</span>
            </a>
